...
echo "SignalP installed at: $SIGNALP_DIR" # /path/to/project/assembly/trinotate_data/signalp6_fast/signalp6_fast/signalp-6-package/signalp

SIGNALP_CONDA_DIR="/path/to/conda/envs/trinotate_env/lib/python3.11/site-packages/signalp"

# Copy the fast model into the conda model_weights directory:
cd /path/to/conda/envs/trinotate_env/lib/python3.11/site-packages/signalp
mkdir -p model_weights
cp -r /path/to/project/assembly/trinotate_data/signalp6_fast/signalp6_fast/signalp-6-package/models/* model_weights
...
# Pfam
cd /path/to/project/assembly/trinotate_output
...
cd /path/to/project/assembly/final_annotation

cp /path/to/project/assembly/trinotate_output/Festuca_rubra.annotation_report_strict.xls.gz .
gunzip Festuca_rubra.annotation_report_strict.xls.gz

/path/to/conda/envs/trinotate_env/bin/trinotate_report_summary.pl Festuca_rubra.annotation_report_strict.xls Festuca_rubra_report_strict
...
cd /path/to/project/assembly/final_annotation
cp -s /path/to/project/assembly/trinotate_output/eggnog.emapper.annotations .
cp -s /path/to/project/assembly/trinotate_output/rfam.tblout .
...
awk -F'\t' '$1!~"^#" {print $20}' Festuca_rubra_annotation_report_final.tsv | grep -v "^.$" | wc -l   # signalP 296511, ~8%
awk -F'\t' '$1!~"^#" {print $21}' Festuca_rubra_annotation_report_final.tsv | grep -v "^.$" | wc -l   # TMHMM 351811, ~10%
